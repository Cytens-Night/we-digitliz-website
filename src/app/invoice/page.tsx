          ...
          <div className="lg:col-span-7">
            <div className="sticky top-8 bg-[#ffffff] rounded-3xl p-4 md:p-8 border border-black/5 shadow-2xl">
              ...
              >
                ...
                <div className="flex justify-between items-start mb-12">
                  <div>
                    ...
                    <div className="text-2xl font-bold tracking-tighter" style={{ fontFamily: "'Outfit', sans-serif" }}>
                      <span style={{ color: "#0066cc", fontWeight: "bold" }}>wedigitlize</span>
                    </div>
                ...
                <div className="mt-12 text-center text-xs text-gray-300 flex flex-col gap-1">
                  <span>Generated by wedigitlize Professional Invoicing</span>
                  <span>WEDIGITLIZE LTD | Company number 17465598</span>
                </div>
