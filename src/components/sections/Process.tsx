...
export default function Process() {
  ...
  return (
    <section id="process" ref={sectionRef} className="py-16 md:py-32 bg-background transition-colors duration-1000 relative overflow-hidden border-t border-black/15 dark:border-white/15">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1px] h-full bg-black/10 dark:bg-white/10 pointer-events-none" />
        ...
        <div className="flex md:hidden flex-col gap-4 px-2 pb-12">
          {steps.map((step, index) => (
             ...
             >
               ...
               <h4 className="text-2xl font-display font-bold text-black dark:text-white tracking-tight relative z-10 leading-tight mb-2">
                 {step.title}
               </h4>
               <p className="text-black/80 dark:text-white/80 text-sm leading-relaxed relative z-10">
                 {step.desc}
               </p>
             </motion.div>
          ))}
