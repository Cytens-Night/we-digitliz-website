...
export default function About() {
  ...
  return (
    <section id="about" className="relative bg-[#f5f5f7]">
        ...
        <div className="sticky top-0 h-screen flex items-center overflow-hidden">
          ...
          <motion.div style={{ x }} className="flex w-[400vw] h-full items-center relative z-10">
            ...
            <div className="w-[100vw] h-full flex-shrink-0 flex flex-col justify-center px-[5vw] lg:px-[10vw] relative overflow-hidden">
              ...
              <h3 className="text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-display font-bold text-black mb-6 md:mb-8 leading-[1.05]">
                <motion.span 
                ...
                <span className="relative inline-block mt-2">
                  ...
                  <motion.div 
                    ...
                    className="absolute top-1/2 left-[-5%] right-[-5%] h-[8px] md:h-[12px] bg-white origin-left -translate-y-1/2 rotate-[-2deg]"
                  />
                </span>
              </h3>
              ...
              <motion.p 
                ...
                className="text-lg md:text-2xl lg:text-3xl text-black max-w-4xl leading-tight font-medium"
              >
            ...
            <div className="w-[100vw] h-full flex-shrink-0 flex items-center justify-center px-[5vw] lg:px-[10vw]">
              ...
              <div className="w-full lg:w-1/2 h-[35vh] lg:h-[50vh] bg-white rounded-[3rem] shadow-[0_20px_40px_rgba(0,0,0,0.2)] flex flex-col p-6 md:p-10 relative overflow-hidden text-black font-mono text-xs md:text-sm border border-black shrink-0">
              ...
              <div className="w-full lg:w-1/2 h-[35vh] lg:h-[50vh] bg-[#f5f5f7] rounded-[3rem] border border-black/15 shadow-[0_20px_40px_rgba(0,0,0,0.1)] p-6 md:p-10 relative overflow-hidden flex flex-col justify-between group shrink-0">
                 <div className="flex justify-between items-center mb-8 relative z-10">
                   ...
                   <div className="w-12 h-12 rounded-full border-[3px] border-[#1d1d1f]/10 border-t-[#1d1d1f] flex items-center justify-center relative animate-spin duration-3000">
                      <div className="w-2 h-2 bg-white rounded-full absolute top-[-2.5px] left-1/2 -translate-x-1/2" />
                   </div>
                 </div>
