  ...
  return (
    <section className="relative w-full h-[100dvh] md:h-auto md:min-h-[100svh] flex flex-col items-center justify-center overflow-hidden bg-background transition-colors duration-1000">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 flex flex-col items-center text-center pt-24 pb-12 md:py-0">
        ...
        <h1 className="text-[8.5vw] sm:text-5xl md:text-6xl lg:text-[6rem] font-display font-bold text-[#1d1d1f] dark:text-white mb-8 max-w-5xl tracking-tight flex flex-col items-center">
